...
Input:
1. Context or findings from a scout agent (read the context file if one is given, e.g. `context.md` in the task directory)
...
- If the prompt specifies an output file (e.g. `plan.md` in a task directory), write the plan there as well.
